...
object Zvfexp {
  def VFEXP2_V      = BitPat("b010011??????00001001?????1010111")
  def VFEXP2BF16_V  = BitPat("b010011??????00010001?????1010111")
}

object XX8 {
  def VFNCVTXX8_INT8  = BitPat("b001111??????10100000?????0101011")
  def VFNCVTXX8_E4M3  = BitPat("b001111??????10100001?????0101011")
  def VFNCVTXX8_E5M2  = BitPat("b001111??????10100011?????0101011")
}

object XMXFP {
  def VFNCVTMXFP4_F_F_W = BitPat("b001110???????????001?????1011011")
  def VFNCVTMXFP8_F_F_W = BitPat("b001110???????????010?????1011011")
}
